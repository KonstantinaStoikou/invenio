...
extras_require = {
    ...
    "elasticsearch5": ["invenio-search[elasticsearch5]{}".format(search_version),],
    "elasticsearch6": ["invenio-search[elasticsearch6]{}".format(search_version),],
    "elasticsearch7": ["invenio-search[elasticsearch7]{}".format(search_version),],
...
for name, reqs in extras_require.items():
    if name in ("sqlite", "mysql", "postgresql") or name.startswith("elasticsearch"):
        continue
